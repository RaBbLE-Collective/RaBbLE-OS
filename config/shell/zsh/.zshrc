...
# ── Creator app CLI aliases (generated by layer/creator-apps) ─────────────────
[[ -f "${HOME}/.local/state/rabble/creator-apps-aliases.zsh" ]] && \
    source "${HOME}/.local/state/rabble/creator-apps-aliases.zsh"
